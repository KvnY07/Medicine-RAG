...
from ctn2md.utils_llm.llm_summarize_content_qwen_prompt import SYSTEM_PROMPT_SUMMARIZE, USER_PROMPT_SUMMARIZE
...
def summarize_doc_keywords_by_qwen(doc_title, full_content, model="qwen-turbo-1101", question_num=None):
...
| e | （第一排和第二排或第二排和第三排） | | 椅 |"""
    ...
    resp= summarize_doc_keywords_by_qwen(doc_title, page_content)
    rich.print(resp)
